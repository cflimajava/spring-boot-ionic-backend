...
import com.cflima.cursomc.domain.PagamentoComCartao;
...
import com.cflima.cursomc.repositories.CidadeRepository;
...
public class DBMockService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "criferlim@yahoo.com.br", "36378912377", TipoCliente.PESSOAFISICA, passwordEncode.encode("123456"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Jose Silva", "cristianolima_udi@hotmail.com", "76309796658", TipoCliente.PESSOAFISICA, passwordEncode.encode("123456"));
		cli2.setPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("32235844", "998985544"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);		
		Endereco e3 = new Endereco(null, "Rua 21 de Abril", "175", "Fundo", "Luizote de Santos", "38777013", cli2, c2);
